...
rankingUrl = input("Type the ranking URL")

try:
    scraper = cloudscraper.create_scraper()  # returns a CloudScraper instance
    mySite = scraper.get(rankingUrl).text
    print("Ranking scrapped!")
except:
    print("Invalid URL or cannot scrap it")
...
if int(number) < 1 or int(number) > 30:
    ...
    f = open("./project_hltv_ranking/pagev2.html","w+",encoding = "utf-8")
    f.write(mySite)


    with open("./project_hltv_ranking/pagev2.html","r",encoding = "utf-8") as s:
